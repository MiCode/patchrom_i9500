...
.method static constructor <clinit>()V
    ...
    .line 100
    new-instance v0, Lcom/android/settings_ex/guide/GuideFragment$SettingsHeader;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/settings_ex/guide/GuideFragment$SettingsHeader;-><init>(Ljava/lang/String;IJLcom/android/settings_ex/guide/GuideFragment$GuideModes;)V

    sput-object v0, Lcom/android/settings_ex/guide/GuideFragment$SettingsHeader;->NONE:Lcom/android/settings_ex/guide/GuideFragment$SettingsHeader;

    .line 102
    new-instance v3, Lcom/android/settings_ex/guide/GuideFragment$SettingsHeader;

    const-string v4, "WIFI"

    const-wide/32 v6, 0x7f0b04df

    sget-object v8, Lcom/android/settings_ex/guide/GuideFragment$GuideModes;->WIFI_SETTINGS:Lcom/android/settings_ex/guide/GuideFragment$GuideModes;

    move v5, v9

    invoke-direct/range {v3 .. v8}, Lcom/android/settings_ex/guide/GuideFragment$SettingsHeader;-><init>(Ljava/lang/String;IJLcom/android/settings_ex/guide/GuideFragment$GuideModes;)V

    sput-object v3, Lcom/android/settings_ex/guide/GuideFragment$SettingsHeader;->WIFI:Lcom/android/settings_ex/guide/GuideFragment$SettingsHeader;
    ...
    const-wide/32 v6, 0x7f0b04e1

    sget-object v8, Lcom/android/settings_ex/guide/GuideFragment$GuideModes;->BLUETOOTH_SETTING:Lcom/android/settings_ex/guide/GuideFragment$GuideModes;

    move v5, v10

    invoke-direct/range {v3 .. v8}, Lcom/android/settings_ex/guide/GuideFragment$SettingsHeader;-><init>(Ljava/lang/String;IJLcom/android/settings_ex/guide/GuideFragment$GuideModes;)V

    sput-object v3, Lcom/android/settings_ex/guide/GuideFragment$SettingsHeader;->BLUETOOTH:Lcom/android/settings_ex/guide/GuideFragment$SettingsHeader;
...
.method static fromId(J)Lcom/android/settings_ex/guide/GuideFragment$SettingsHeader;
    .locals 7
    .parameter "id"

    .prologue
    .line 131
    sget-object v4, Lcom/android/settings_ex/guide/GuideFragment$SettingsHeader;->NONE:Lcom/android/settings_ex/guide/GuideFragment$SettingsHeader;

    .line 133
    .local v4, retval:Lcom/android/settings_ex/guide/GuideFragment$SettingsHeader;
    ...
    .local v0, arr$:[Lcom/android/settings_ex/guide/GuideFragment$SettingsHeader;
    array-length v3, v0
    ...
    .line 134
    .local v2, item:Lcom/android/settings_ex/guide/GuideFragment$SettingsHeader;
    iget-wide v5, v2, Lcom/android/settings_ex/guide/GuideFragment$SettingsHeader;->mHeaderId:J
    ...
    .line 140
    .end local v2           #item:Lcom/android/settings_ex/guide/GuideFragment$SettingsHeader;
    :cond_0
    return-object v4

    .line 133
    .restart local v2       #item:Lcom/android/settings_ex/guide/GuideFragment$SettingsHeader;
    :cond_1
