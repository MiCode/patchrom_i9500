...
.field static final TAG:Ljava/lang/String; = "StorageVolumePreferenceCategory"
...
.method public constructor <init>(Landroid/content/Context;Landroid/content/res/Resources;Landroid/os/storage/StorageVolume;Landroid/os/storage/StorageManager;Z)V
    ...
    iput-object v4, p0, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mStorageManager:Landroid/os/storage/StorageManager;

    .line 157
    new-instance v4, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory$1;

    invoke-direct {v4, p0}, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory$1;-><init>(Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;)V

    iput-object v4, p0, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mUpdateHandler:Landroid/os/Handler;
    ...
    iput-object v4, p0, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mMeasurement:Lcom/android/settings_ex/deviceinfo/StorageMeasurement;

    .line 213
    iget-object v4, p0, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mMeasurement:Lcom/android/settings_ex/deviceinfo/StorageMeasurement;

    invoke-virtual {v4, p0}, Lcom/android/settings_ex/deviceinfo/StorageMeasurement;->setReceiver(Lcom/android/settings_ex/deviceinfo/StorageMeasurement$MeasurementReceiver;)V
    ...
    :goto_1
    iput-boolean v2, p0, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mAllowFormat:Z

    .line 221
    iput-boolean p5, p0, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mPrimary:Z
    ...
    .line 223
    iget-boolean v2, p0, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mPrimary:Z
    ...
    sget-boolean v4, Lcom/android/settings_ex/Utils;->DBG:Z
    ...
    .line 197
    :cond_2
    iput-boolean v3, p0, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mIsUSBOTGStorage:Z
    ...
    .line 201
    iput-boolean v2, p0, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mIsInternalStorage:Z
    ...
    .line 204
    iput-boolean v2, p0, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mIsUSBOTGStorage:Z
...
.method private updatePreferencesFromState()V
    ...
    .line 350
    iget-object v3, p0, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mMountTogglePreference:Landroid/preference/Preference;
    ...
    .line 354
    iget-object v3, p0, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mPreferences:[Landroid/preference/Preference;
    ...
    .line 358
    iget-boolean v3, p0, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mIsUSBOTGStorage:Z
    ...
    iget-object v4, p0, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mResources:Landroid/content/res/Resources;
    ...
    .line 366
    :goto_1
    iget-boolean v3, p0, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mPrimary:Z

    if-nez v3, :cond_5

    .line 367
    iget-object v3, p0, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mUsageBarPreference:Lcom/android/settings_ex/deviceinfo/UsageBarPreference;
...
.method public getIsUSBOTGStorage()Z
    ...
    .prologue
    .line 577
    iget-boolean v0, p0, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mIsUSBOTGStorage:Z
...
.method public init()V
    ...
    .prologue
    .line 232
    new-instance v6, Lcom/android/settings_ex/deviceinfo/UsageBarPreference;

    invoke-virtual {p0}, Landroid/preference/Preference;->getContext()Landroid/content/Context;

    move-result-object v7

    invoke-direct {v6, v7}, Lcom/android/settings_ex/deviceinfo/UsageBarPreference;-><init>(Landroid/content/Context;)V

    iput-object v6, p0, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mUsageBarPreference:Lcom/android/settings_ex/deviceinfo/UsageBarPreference;
    ...
    .line 237
    .local v0, height:I
    sget-object v6, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->sCategoryInfos:[Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory$CategoryInfo;
    ...
    iput-object v6, p0, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mPreferences:[Landroid/preference/Preference;

    .line 239
    new-array v6, v2, [I

    iput-object v6, p0, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mColors:[I
    ...
    iget-object v6, p0, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mPreferences:[Landroid/preference/Preference;
    ...
    iget v6, v6, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory$CategoryInfo;->mTitle:I
    ...
    iget-boolean v6, p0, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mPrimary:Z

    if-eqz v6, :cond_0

    .line 247
    iget-object v6, p0, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mColors:[I
    ...
    sget-object v8, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->sCategoryInfos:[Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory$CategoryInfo;

    aget-object v8, v8, v1

    iget v8, v8, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory$CategoryInfo;->mColor:I
    ...
    invoke-static {v5, v0, v6}, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->createRectShape(III)Landroid/graphics/drawable/ShapeDrawable;
    ...
    iput-object v6, p0, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mMountTogglePreference:Landroid/preference/Preference;

    .line 254
    iget-boolean v6, p0, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mIsUSBOTGStorage:Z
    ...
    .line 257
    iget-boolean v6, p0, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mAllowFormat:Z
    ...
    iput-object v6, p0, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mFormatPreference:Landroid/preference/Preference;
    ...
    :try_start_0
    iget-boolean v6, p0, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mIsInternalStorage:Z
    ...
    iput-object v6, p0, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mStorageLow:Landroid/preference/Preference;

    .line 285
    iget-object v6, p0, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mStorageLow:Landroid/preference/Preference;
...
.method public intentForClick(Landroid/preference/Preference;)Landroid/content/Intent;
    ...
    const-class v3, Lcom/android/settings_ex/MediaFormat;
    ...
    const-class v3, Lcom/android/settings_ex/MediaFormatSd;
    ...
    const-class v3, Lcom/android/settings_ex/Settings$ManageApplicationsActivity;
...
.method public updateExact(JJJJJ[J)V
    ...
    invoke-virtual {v2, v5, v6}, Lcom/android/settings_ex/deviceinfo/UsageBarPreference;->addEntry(FI)V
    ...
    iget v7, v2, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory$MediaCategory;->mCategory:I
    ...
    invoke-direct/range {v8 .. v13}, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->updatePreference(JJI)V
