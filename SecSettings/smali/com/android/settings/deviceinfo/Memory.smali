...
.field private mMountToggleClickedCategory:Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;
...
.method public constructor <init>()V
    ...
    .line 79
    iput-object v0, p0, Lcom/android/settings_ex/deviceinfo/Memory;->mMountToggleClickedCategory:Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;
...
.method private doUnmount()V
    ...
    .line 330
    iget-object v2, p0, Lcom/android/settings_ex/deviceinfo/Memory;->mMountToggleClickedCategory:Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;
    ...
    invoke-virtual {v2}, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->getIsUSBOTGStorage()Z
...
.method public initMountedStorageVolume()V
    ...
    .line 423
    :cond_0
    iget-object v1, p0, Lcom/android/settings_ex/deviceinfo/Memory;->mStorageManager:Landroid/os/storage/StorageManager;
    ...
    .line 433
    .local v13, subsystem:Ljava/lang/String;
    iget-object v1, p0, Lcom/android/settings_ex/deviceinfo/Memory;->mStorageManager:Landroid/os/storage/StorageManager;
    ...
    .end local v13           #subsystem:Ljava/lang/String;
    :goto_1
    ...
    .restart local v13       #subsystem:Ljava/lang/String;
    :cond_2
    const-string v1, "MemorySettings"
    ...
    .line 445
    new-array v1, v10, [Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;

    iput-object v1, p0, Lcom/android/settings_ex/deviceinfo/Memory;->mStorageVolumePreferenceCategories:[Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;
    ...
    .line 456
    .local v0, storagePreferenceCategory:Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;
    iget-object v1, p0, Lcom/android/settings_ex/deviceinfo/Memory;->mStorageVolumePreferenceCategories:[Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;
    ...
    .line 446
    .end local v0           #storagePreferenceCategory:Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;
    :cond_5
    add-int/lit8 v7, v7, 0x1
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 105
    :cond_1
    invoke-virtual {p0}, Lcom/android/settings_ex/deviceinfo/Memory;->initMountedStorageVolume()V
...
.method public onCreateDialog(I)Landroid/app/Dialog;
    ...
    .line 280
    :pswitch_0
    iget-object v0, p0, Lcom/android/settings_ex/deviceinfo/Memory;->mMountToggleClickedCategory:Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;
    ...
    invoke-virtual {v0}, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->getIsUSBOTGStorage()Z
    ...
    invoke-direct {v1, p0}, Lcom/android/settings_ex/deviceinfo/Memory$4;-><init>(Lcom/android/settings_ex/deviceinfo/Memory;)V

    invoke-virtual {v0, v3, v1}, Landroid/app/AlertDialog$Builder;->setPositiveButton(ILandroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;

    move-result-object v0

    new-instance v1, Lcom/android/settings_ex/deviceinfo/Memory$3;

    invoke-direct {v1, p0}, Lcom/android/settings_ex/deviceinfo/Memory$3;-><init>(Lcom/android/settings_ex/deviceinfo/Memory;)V
    ...
    new-instance v1, Lcom/android/settings_ex/deviceinfo/Memory$6;

    invoke-direct {v1, p0}, Lcom/android/settings_ex/deviceinfo/Memory$6;-><init>(Lcom/android/settings_ex/deviceinfo/Memory;)V
    ...
    invoke-direct {v1, p0}, Lcom/android/settings_ex/deviceinfo/Memory$5;-><init>(Lcom/android/settings_ex/deviceinfo/Memory;)V
    ...
    .line 309
    :pswitch_1
    iget-object v1, p0, Lcom/android/settings_ex/deviceinfo/Memory;->mMountToggleClickedCategory:Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;
    ...
    invoke-virtual {v1}, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->getIsUSBOTGStorage()Z
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .local v0, i:I
    :goto_0
    iget-object v6, p0, Lcom/android/settings_ex/deviceinfo/Memory;->mStorageVolumePreferenceCategories:[Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;
    ...
    .line 239
    .local v4, svpc:Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;
    invoke-virtual {v4, p2}, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->intentForClick(Landroid/preference/Preference;)Landroid/content/Intent;
    ...
    .end local v4           #svpc:Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;
    :cond_0
    :goto_1
    return v5
    ...
    .restart local v4       #svpc:Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;
    :cond_1
    invoke-virtual {v4, p2}, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->mountToggleClicked(Landroid/preference/Preference;)Z
    ...
    .line 250
    invoke-virtual {v4}, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->getStorageVolume()Landroid/os/storage/StorageVolume;
    ...
    iput-object v6, p0, Lcom/android/settings_ex/deviceinfo/Memory;->mClickedMountPoint:Ljava/lang/String;
...
.method public onResume()V
    ...
    iget-object v5, p0, Lcom/android/settings_ex/deviceinfo/Memory;->mMediaScannerReceiver:Landroid/content/BroadcastReceiver;
    ...
    .line 134
    iget-object v4, p0, Lcom/android/settings_ex/deviceinfo/Memory;->mInternalStorageVolumePreferenceCategory:Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;
    ...
    invoke-virtual {v4}, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->onResume()V
    ...
    .local v1, i:I
    :goto_0
    iget-object v4, p0, Lcom/android/settings_ex/deviceinfo/Memory;->mStorageVolumePreferenceCategories:[Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;
    ...
    .line 147
    iget-object v4, p0, Lcom/android/settings_ex/deviceinfo/Memory;->mLastClickedMountToggle:Landroid/preference/Preference;
