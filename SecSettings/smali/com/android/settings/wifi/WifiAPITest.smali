...
.method static synthetic access$000(Lcom/android/settings_ex/wifi/WifiAPITest;)Landroid/app/AlertDialog;
    .locals 1
    .parameter "x0"

    .prologue
    .line 41
    iget-object v0, p0, Lcom/android/settings_ex/wifi/WifiAPITest;->dialog:Landroid/app/AlertDialog;

    return-object v0
.end method

.method static synthetic access$100(Lcom/android/settings_ex/wifi/WifiAPITest;)I
    .locals 1
    .parameter "x0"
...
.method static synthetic access$102(Lcom/android/settings_ex/wifi/WifiAPITest;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$200(Lcom/android/settings_ex/wifi/WifiAPITest;)Landroid/net/wifi/WifiManager;
    .locals 1
    .parameter "x0"
...
.method public onPreferenceClick(Landroid/preference/Preference;)Z
    ...
    .prologue
    .line 106
    iget-object v3, p0, Lcom/android/settings_ex/wifi/WifiAPITest;->mWifiDisconnect:Landroid/preference/Preference;

    if-ne p1, v3, :cond_1

    .line 107
    iget-object v3, p0, Lcom/android/settings_ex/wifi/WifiAPITest;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    .line 108
    :cond_1
    iget-object v3, p0, Lcom/android/settings_ex/wifi/WifiAPITest;->mWifiDisableNetwork:Landroid/preference/Preference;

    if-eq p1, v3, :cond_2

    iget-object v3, p0, Lcom/android/settings_ex/wifi/WifiAPITest;->mWifiEnableNetwork:Landroid/preference/Preference;
    ...
    .line 113
    new-instance v2, Lcom/android/settings_ex/wifi/WifiAPITest$1;

    invoke-direct {v2, p0}, Lcom/android/settings_ex/wifi/WifiAPITest$1;-><init>(Lcom/android/settings_ex/wifi/WifiAPITest;)V
    ...
    new-instance v4, Lcom/android/settings_ex/wifi/WifiAPITest$2;

    invoke-direct {v4, p0, v1}, Lcom/android/settings_ex/wifi/WifiAPITest$2;-><init>(Lcom/android/settings_ex/wifi/WifiAPITest;Landroid/widget/EditText;)V
    ...
    new-instance v4, Lcom/android/settings_ex/wifi/WifiAPITest$4;

    invoke-direct {v4, p0}, Lcom/android/settings_ex/wifi/WifiAPITest$4;-><init>(Lcom/android/settings_ex/wifi/WifiAPITest;)V
    ...
    iput-object v3, p0, Lcom/android/settings_ex/wifi/WifiAPITest;->dialog:Landroid/app/AlertDialog;

    .line 163
    iget-object v3, p0, Lcom/android/settings_ex/wifi/WifiAPITest;->dialog:Landroid/app/AlertDialog;

    new-instance v4, Lcom/android/settings_ex/wifi/WifiAPITest$5;

    invoke-direct {v4, p0}, Lcom/android/settings_ex/wifi/WifiAPITest$5;-><init>(Lcom/android/settings_ex/wifi/WifiAPITest;)V
    ...
    new-instance v4, Lcom/android/settings_ex/wifi/WifiAPITest$3;

    invoke-direct {v4, p0, v1}, Lcom/android/settings_ex/wifi/WifiAPITest$3;-><init>(Lcom/android/settings_ex/wifi/WifiAPITest;Landroid/widget/EditText;)V
