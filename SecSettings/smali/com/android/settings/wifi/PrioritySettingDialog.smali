.class public Lcom/android/settings_ex/wifi/PrioritySettingDialog;
...
# static fields
.field static final BUTTON_PRIORITY_DOWN:I = -0x3

.field static final BUTTON_PRIORITY_NONE:I = 0x0

.field static final BUTTON_PRIORITY_SAVE:I = -0x2

.field static final BUTTON_PRIORITY_UP:I = -0x1

.field private static final TAG:Ljava/lang/String; = "WifiPriorityDialog"
...
# direct methods
.method constructor <init>(Landroid/content/Context;Lcom/android/settings_ex/wifi/AccessPoint;)V
    .locals 1
    .parameter "context"
    ...
    .line 109
    iput-object p1, p0, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->mContext:Landroid/content/Context;

    .line 110
    iput-object p2, p0, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->mAccessPoint:Lcom/android/settings_ex/wifi/AccessPoint;
    ...
    :goto_0
    iput v0, p0, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->mSecurity:I
...
.method static synthetic access$000(Lcom/android/settings_ex/wifi/PrioritySettingDialog;)Landroid/content/Context;
    .locals 1
    .parameter "x0"

    .prologue
    .line 79
    iget-object v0, p0, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->mContext:Landroid/content/Context;
...
.method private validatePriorityButtons()V
    ...
    .line 366
    iget-object v2, p0, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->mRadioGroup:Landroid/widget/RadioGroup;
    ...
    .line 367
    .local v0, id:I
    iget-object v2, p0, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->orderedConfigs:Ljava/util/List;
...
.method public cancel()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->cancelOrDismiss(Z)V
...
.method protected cancelOrDismiss(Z)V
    ...
    iget v2, p0, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->mPriorityButton:I
    ...
    .line 341
    iget v0, p0, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->mPriorityButton:I
    ...
    iput v0, p0, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->mPriorityButton:I
...
.method public isConnectionActive()Z
    ...
    .line 221
    iget-object v2, p0, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->mAccessPoint:Lcom/android/settings_ex/wifi/AccessPoint;
...
.method public onCheckedChanged(Landroid/widget/RadioGroup;I)V
    ...
    .line 357
    invoke-direct {p0}, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->validatePriorityButtons()V
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    .line 239
    iput p2, p0, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->mPriorityButton:I

    .line 242
    iget-object v6, p0, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->mRadioGroup:Landroid/widget/RadioGroup;
    ...
    .line 247
    :cond_1
    iget-object v6, p0, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->orderedConfigs:Ljava/util/List;
    ...
    invoke-static {v6}, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->resortOrderedConfigs(Ljava/util/List;)V

    .line 254
    add-int/lit8 v6, v2, -0x1

    invoke-virtual {p0, v6}, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->updateRadioGroup(I)V
    ...
    .line 275
    iget-object v6, p0, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->mWifiManager:Landroid/net/wifi/WifiManager;

    iget-object v7, p0, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->mSaveListener:Landroid/net/wifi/WifiManager$ActionListener;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v3, p0, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->mView:Landroid/view/View;

    .line 118
    iget-object v3, p0, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->mView:Landroid/view/View;
    ...
    iput-object v3, p0, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    iget-object v5, p0, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->mPriorityView:Landroid/view/ViewGroup;
    ...
    iput-object v3, p0, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->mPriorityView:Landroid/view/ViewGroup;

    .line 126
    iget-object v3, p0, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->mPriorityView:Landroid/view/ViewGroup;
    ...
    .line 129
    new-instance v3, Lcom/android/settings_ex/wifi/PrioritySettingDialog$1;

    invoke-direct {v3, p0}, Lcom/android/settings_ex/wifi/PrioritySettingDialog$1;-><init>(Lcom/android/settings_ex/wifi/PrioritySettingDialog;)V

    iput-object v3, p0, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->mSaveListener:Landroid/net/wifi/WifiManager$ActionListener;
    ...
    iput-object v3, p0, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->mRadioGroup:Landroid/widget/RadioGroup;

    .line 140
    iget-object v3, p0, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->mRadioGroup:Landroid/widget/RadioGroup;
    ...
    .line 156
    iget-object v3, p0, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->mWifiManager:Landroid/net/wifi/WifiManager;

    invoke-static {v3}, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->getOrderedConfigs(Landroid/net/wifi/WifiManager;)Ljava/util/List;

    move-result-object v3

    iput-object v3, p0, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->orderedConfigs:Ljava/util/List;

    .line 157
    invoke-virtual {p0, v6}, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->updateRadioGroup(I)V

    .line 158
    iput v6, p0, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->mPriorityButton:I
...
.method protected updateRadioGroup(I)V
    ...
    iget-object v8, p0, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->orderedConfigs:Ljava/util/List;
    ...
    iget-object v6, p0, Lcom/android/settings_ex/wifi/PrioritySettingDialog;->mContext:Landroid/content/Context;
