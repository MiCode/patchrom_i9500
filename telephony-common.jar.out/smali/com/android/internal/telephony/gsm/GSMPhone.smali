...
.field mEccNums:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;Lcom/android/internal/telephony/PhoneNotifier;ZI)V
    ...
    .line 164
    iput-object v6, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mEccNums:Ljava/lang/String;
    ...
    invoke-virtual {p0, p0, v0, v6}, Lcom/android/internal/telephony/PhoneBase;->registerForServiceStateChanged(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method private handleCfuQueryResult([Lcom/android/internal/telephony/CallForwardInfo;)V
    ...
    .line 2677
    .local v3, r:Lcom/android/internal/telephony/IccRecords;
    if-eqz v3, :cond_1
    ...
    invoke-virtual {v3, v6, v5, v8}, Lcom/android/internal/telephony/IccRecords;->setCallForwardingFlag(ILjava/lang/Boolean;Ljava/lang/Boolean;)V
    ...
    invoke-virtual {v3, v6, v5, v8}, Lcom/android/internal/telephony/IccRecords;->setVoiceCallForwardingFlag(IZLjava/lang/String;)V
    ...
    invoke-virtual {v3, v6, v5, v8}, Lcom/android/internal/telephony/IccRecords;->setVideoCallForwardingFlag(IZLjava/lang/String;)V
    ...
    .line 2704
    invoke-virtual {v3, v6, v7}, Lcom/android/internal/telephony/IccRecords;->setVoiceCallForwardingFlag(IZ)V
    ...
    .line 2707
    invoke-virtual {v3, v6, v7}, Lcom/android/internal/telephony/IccRecords;->setVideoCallForwardingFlag(IZ)V
...
.method public dial(Ljava/lang/String;Lcom/android/internal/telephony/UUSInfo;Lcom/android/internal/telephony/Call$CallType;)Lcom/android/internal/telephony/Connection;
    ...
    check-cast v13, Lcom/android/internal/telephony/UiccCardApplication;

    move-object/from16 v0, p0

    invoke-static {v9, v0, v13}, Lcom/android/internal/telephony/gsm/GsmMmiCode;->newFromDialString(Ljava/lang/String;Lcom/android/internal/telephony/gsm/GSMPhone;Lcom/android/internal/telephony/UiccCardApplication;)Lcom/android/internal/telephony/gsm/GsmMmiCode;
...
.method public dialVideoCall(Ljava/lang/String;Lcom/android/internal/telephony/Call$CallType;)Lcom/android/internal/telephony/Connection;
    ...
    check-cast v5, Lcom/android/internal/telephony/UiccCardApplication;
...
.method public getFDNavailable()Z
    ...
    instance-of v1, v0, Lcom/android/internal/telephony/gsm/SIMRecords;
    ...
    .line 2796
    .end local v0           #iccRecords:Lcom/android/internal/telephony/IccRecords;
    :goto_1
    return v2

    .restart local v0       #iccRecords:Lcom/android/internal/telephony/IccRecords;
    :cond_1
    move v1, v2
    ...
    .end local v0           #iccRecords:Lcom/android/internal/telephony/IccRecords;
    iget-boolean v2, v0, Lcom/android/internal/telephony/gsm/SIMRecords;->isAvailableFDN:Z
...
.method public getSMSPavailable()Z
    ...
    .end local v0           #iccRecords:Lcom/android/internal/telephony/IccRecords;
    iget-boolean v2, v0, Lcom/android/internal/telephony/gsm/SIMRecords;->isAvailableSMSP:Z
...
.method public getSMSavailable()Z
    ...
    .end local v0           #iccRecords:Lcom/android/internal/telephony/IccRecords;
    iget-boolean v2, v0, Lcom/android/internal/telephony/gsm/SIMRecords;->isAvailableSMS:Z
...
.method public getVoiceMailNumber()Ljava/lang/String;
    ...
    invoke-virtual {v4}, Lcom/android/internal/telephony/gsm/SIMRecords;->getisVoiceMailFixed()Z
    ...
    const-string v5, "[Voicemail] voice mail number from getvoiceMailNumber()"
    ...
    const-string v5, "[Voicemail] voice mail number from getString()"
...
.method public hasIsim()Z
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/IccRecords;->hasIsim()Z
...
.method public sendEncodedUssd([BII)V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/internal/telephony/gsm/GsmMmiCode;-><init>(Lcom/android/internal/telephony/gsm/GSMPhone;Lcom/android/internal/telephony/UiccCardApplication;)V
...
.method public setCallForwardingOption(IILjava/lang/String;IILandroid/os/Message;)V
    ...
    :goto_0
    invoke-virtual {p0, v1, v0, p5, p6}, Landroid/os/Handler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
...
.method public setEmergencyNumbers(Ljava/lang/String;)V
    ...
    iget-object v15, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->mSST:Lcom/android/internal/telephony/gsm/MultiSimGsmServiceStateTracker;

    iget-object v12, v15, Lcom/android/internal/telephony/ServiceStateTracker;->ss:Landroid/telephony/ServiceState;
    ...
    iget-object v15, v0, Lcom/android/internal/telephony/PhoneBase;->mContext:Landroid/content/Context;
    ...
    iget-object v2, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->mEccNums:Ljava/lang/String;
    ...
    iput-object v15, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->mPrevSs:Landroid/telephony/ServiceState;
    ...
    invoke-virtual {v0, v6, v15}, Lcom/android/internal/telephony/gsm/GSMPhone;->setSystemProperty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v17, "setEmergencyNumbers: ecclist "
...
.method public setVoiceMailNumber(Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
    ...
    new-instance v3, Lcom/android/internal/telephony/IccVmNotSupportedException;

    const-string v4, "Update SIM voice mailbox error"

    invoke-direct {v3, v4}, Lcom/android/internal/telephony/IccVmNotSupportedException;-><init>(Ljava/lang/String;)V
...
.method public updateMessageWaitingIndicator(Z)V
    ...
    :goto_0
    invoke-virtual {v0, v2, v1}, Lcom/android/internal/telephony/IccRecords;->setVoiceMessageWaiting(II)V
...
.method public updateMessageWaitingIndicatorWithCount(I)V
    ...
    const-string v3, "updateMessageWaitingIndicatorWithCount: mwi = "
