...
.method static constructor <clinit>()V
    ...
    :goto_1
    const-string/jumbo v5, "sync.max_init_syncs"

    invoke-static {v5, v0}, Landroid/os/SystemProperties;->getInt(Ljava/lang/String;I)I

    move-result v5

    sput v5, Landroid/content/SyncManager;->MAX_SIMULTANEOUS_INITIALIZATION_SYNCS:I

    .line 108
    const-string/jumbo v5, "sync.max_regular_syncs"

    invoke-static {v5, v1}, Landroid/os/SystemProperties;->getInt(Ljava/lang/String;I)I

    move-result v5

    sput v5, Landroid/content/SyncManager;->MAX_SIMULTANEOUS_REGULAR_SYNCS:I

    .line 110
    const-string/jumbo v5, "sync.local_sync_delay"

    invoke-static {v5, v8, v9}, Landroid/os/SystemProperties;->getLong(Ljava/lang/String;J)J

    move-result-wide v5

    sput-wide v5, Landroid/content/SyncManager;->LOCAL_SYNC_DELAY:J

    .line 112
    const-string/jumbo v5, "sync.max_time_per_sync"
    ...
    sput-wide v5, Landroid/content/SyncManager;->MAX_TIME_PER_SYNC:J

    .line 114
    const-string/jumbo v5, "sync.notification_delay"

    invoke-static {v5, v8, v9}, Landroid/os/SystemProperties;->getLong(Ljava/lang/String;J)J

    move-result-wide v5

    sput-wide v5, Landroid/content/SyncManager;->SYNC_NOTIFICATION_DELAY:J
    ...
    :goto_2
    sput-boolean v3, Landroid/content/SyncManager;->DBG:Z
...
.method static synthetic access$3500()Z
    ...
    .prologue
    .line 90
    sget-boolean v0, Landroid/content/SyncManager;->DBG:Z
...
.method maybeRescheduleSync(Landroid/content/SyncResult;Landroid/content/SyncOperation;)V
    ...
    .line 900
    :cond_a
    sget-boolean v1, Landroid/content/SyncManager;->DBG:Z
